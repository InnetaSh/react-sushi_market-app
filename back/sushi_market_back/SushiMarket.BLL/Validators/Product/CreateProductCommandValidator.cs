...
{
    public class CreateProductCommandValidator : PositiveCategoryIdValidator<CreateProductCommand>
    {
        public CreateProductCommandValidator()
        {
            ...
            RuleFor(x => x.WeightOrVolume)
                .NotEmpty()
                .WithMessage(string.Format(ErrorMessages.FieldIsRequired, nameof(CreateProductCommand.WeightOrVolume)));
        }
    }
}