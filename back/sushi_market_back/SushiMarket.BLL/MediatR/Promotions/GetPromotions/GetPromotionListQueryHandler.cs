...
{
    public class GetPromotionListQueryHandler : IRequestHandler<GetPromotionListQuery, IEnumerable<PromotionDto>>
    {
        private readonly SushiMarketDbContext _context;
        private readonly IMapper _mapper;

        public GetPromotionListQueryHandler(SushiMarketDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
